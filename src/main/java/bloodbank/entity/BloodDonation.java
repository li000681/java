...
@NamedQuery( name = BloodDonation.ALL_BLOODDONATIONS_QUERY, 
query = "SELECT distinct b FROM BloodDonation b left JOIN FETCH b.bank left join fetch b.record")
@NamedQuery( name = BloodDonation.ALL_BLOODDONATIONS_QUERY_BY_ID, 
query = "SELECT distinct b FROM BloodDonation b left join fetch b.bank left join fetch b.record where b.id=:param1")
...
public class BloodDonation extends PojoBase implements Serializable {
	...
	public static final String ALL_BLOODDONATIONS_QUERY = "BloodDonation.findAll";
	public static final String ALL_BLOODDONATIONS_QUERY_BY_ID = "BloodDonation.findByID";
