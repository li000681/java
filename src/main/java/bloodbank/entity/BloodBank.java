...
@NamedQuery( name = BloodBank.IS_DUPLICATE_QUERY_NAME, query = "SELECT distinct count(b) FROM BloodBank b where b.name =: param1")
@NamedQuery(name=BloodBank.ALL_BLOODBANKS_QUERY_BY_ID, query="SELECT distinct b FROM BloodBank b left JOIN FETCH b.donations where b.id=:param1")
...
public abstract class BloodBank extends PojoBase implements Serializable {
	...
	public static final String ALL_BLOODBANKS_QUERY_BY_ID = "BloodBank.findByID";
